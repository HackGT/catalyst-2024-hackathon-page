...
const TracksSection = () => {
    return (
        <div id="tracks" className="p-10">
            <h2 className="text-6xl text-textColorDark font-coco font-bold text-center mb-8">EXPLORE THE TRACKS!</h2>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 text-center mb-5">
                ...
                <div>
                    ...
                    <p className="text-3xl font-bubblegum">As data becomes more and more valuable, so do the methods we use to secure it.
                ...
                <div>
                    <h3 className="text-3xl md:text-3xl text-textColorDark font-coco font-bold text-center mb-5">ENTREPRENEURSHIP</h3>
                    <p className="text-3xl font-bubblegum">Ready to turn your startup dreams into a reality?  Whether you are a seasoned entrepreneur or just starting out, this course will provide you
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4 text-center mb-5">
                <div>
                    <h3 className="text-4xl text-textColorDark font-coco font-bold text-center mb-5">MATH IS FUN!</h3>
                    <p className="text-3xl font-bubblegum">Dive into the electrifying world of algorithms, graph theory, and fractals with our dynamic interactive sessions and
                ...
                <div>
                    <h3 className="text-4xl text-textColorDark font-coco font-bold text-center mb-5">PROTEIN MODELING</h3>
                    <p className="text-3xl font-bubblegum">Have you ever wondered about the way biological and molecular materials were modeled? In this workshop, you will
