    ...
    return (
        <div className="tracks p-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 text-center mb-5">
                <div>
                    <h3 className="text-3xl text-textColorDark font-coco font-bold text-center mb-5">3D DESIGN</h3>
                    <p className="text-sm font-bubblegum"> Immerse yourselves into three-dimensional creativity with this workshop! It will be the key to guiding you through the
                ...
                <div>
                    <h3 className="text-3xl text-textColorDark font-coco font-bold text-center mb-5">CYBERSECURITY</h3>
                    <p className="text-sm font-bubblegum">As data becomes more and more valuable, so do the methods we use to secure it.
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4 text-center mb-5">
                <div>
                    <h3 className="text-3xl text-textColorDark font-coco font-bold text-center mb-5">MATH IS FUN!</h3>
                    <p className="text-sm font-bubblegum">Dive into the electrifying world of algorithms, graph theory, and fractals with our dynamic interactive sessions and
                ...
                <div>
                    <h3 className="text-3xl text-textColorDark font-coco font-bold text-center mb-5">PROTEIN MODELING</h3>
                    <p className="text-sm font-bubblegum">Have you ever wondered about the way biological and molecular materials were modeled? In this workshop, you will
