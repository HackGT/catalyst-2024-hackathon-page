        ...
        <div id="tracks" className="p-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 text-center mb-5">
                <div>
                    ...
                    <p className="text-lg md:text-2xl font-bubblegum"> Immerse yourselves into three-dimensional creativity with this workshop! It will be the key to guiding you through the
                ...
                <div>
                    ...
                    <p className="text-lg md:text-2xl font-bubblegum">As data becomes more and more valuable, so do the methods we use to secure it.
                ...
                <div>
                    ...
                    <p className="text-lg md:text-2xl font-bubblegum">Ready to turn your startup dreams into a reality?  Whether you are a seasoned entrepreneur or just starting out, this course will provide you
                        with the necessary resources, support, and connections you need to succeed.</p>
                </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4 text-center mb-5 pt-5">
                <div>
                    <h3 className="text-2xl md:text-4xl text-textColorDark font-coco font-bold text-center mb-5">MATH IS FUN!</h3>
                    <p className="text-lg md:text-2xl font-bubblegum">Dive into the electrifying world of algorithms, graph theory, and fractals with our dynamic interactive sessions and
                ...
                <div>
                    ...
                    <p className="text-lg md:text-2xl font-bubblegum">Have you ever wondered about the way biological and molecular materials were modeled? In this workshop, you will
