    ...
    return (
        <section className="my-4">
            <div className="max-w-7xl mx-auto p-4 text-left">
                <h2 className="text-6xl text-textColor font-coco font-bold pb-3">OUR GOALS</h2>
                <ul className="text-3xl font-bubblegum list-disc pl-6">
                ...
                <p className="text-3xl font-bubblegum mt-4">
