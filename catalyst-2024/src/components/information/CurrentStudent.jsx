...
const GeorgiaTechSection = () => {
    return (
        <section className="my-4">
            <div className="max-w-7xl mx-auto p-4 font-bubblegum text-left">
                <h2 className="text-6xl text-textColor font-coco font-bold pb-3">IF YOU ARE A CURRENT GEORGIA TECH STUDENT</h2>
                <p className="text-3xl" >You're still able to participate in the event! Each year, GT students volunteer as mentors to help
                ...
                <p className="text-3xl pt-3">The core responsibilities of mentors include:</p>
                <ul className="text-3xl list-disc pl-6 space-y-1">
                ...
                <p className="text-3xl pt-4">Mentor registration is opening soon!</p>
            </div>
        </section>
    );
};
