    ...
    return (
        <section className="my-4">
            <div className="max-w-7xl mx-auto p-4 text-left">
                <h2 className="text-6xl text-textColor font-coco font-bold pb-3">WHAT TO EXPECT</h2>
                <p className="text-3xl font-bubblegum">Throughout the day, students will have the opportunity to follow three of five tracks: 3D Design, Cybersecurity, Entrepreneurship, Math is Fun, or Protein Modeling. <br />  <br />
