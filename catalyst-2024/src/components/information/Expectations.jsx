    ...
    return (
        <section className="my-4">
            <div className="max-w-3xl mx-auto p-4 text-left">
                ...
                <p className="font-bubblegum">Throughout the day, students will have the opportunity to follow three of five tracks: 3D Design, Cybersecurity, Entrepreneurship, Math is Fun, or Protein Modeling. <br />  <br />
