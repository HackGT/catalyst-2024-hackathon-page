...
const FrontPage = () => {
    return (
        <div className={`home bg-custom-gradient text-center pt-10 md:pt-44`}>
            ...
            <img src={Seashell} alt="Seashell" className="hidden md:flex absolute left-1/8 top-1/4 transform translate-x-1/3 -translate-y-1/2 h-auto w-auto" />
            <img src={Shell} alt="Shell" className="hidden md:flex absolute right-1/8 top-1/2 transform -translate-x-1/8 -translate-y-1/4 h-auto w-auto" />
            <div className="font-coco text-center pb-24 p-4">
                ...
                <br /><br />
                <p className="text-3xl md:text-5xl text-middleGradient">SATURDAY, APRIL 6TH 2024</p>
            </div>
