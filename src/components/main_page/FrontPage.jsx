  ...
  return (
    <div className={`home bg-bgcustom text-center pt-10 md:pt-20`}>
      ...
      <img
        src={Car}
        alt="Racecar"
        className="hidden lg:flex absolute top-[55%] left-15p h-auto w-auto z-0"
      />
      <img
        src={Bear}
        alt="Bear Driver"
        className="hidden lg:flex absolute top-[55%] left-[44%] h-46 w-46 z-5"
      />
      <div className="font-racesport text-center pb-24 p-4 relative z-50 h-screen">
        ...
        <p className="text-2xl md:text-4xl text-white font-jetbrains pb-32">
          Start Your Engines!
        </p>
      </div>
    </div>
