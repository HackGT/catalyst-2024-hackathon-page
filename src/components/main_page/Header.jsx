        ...
        <nav className="fixed w-full z-50 hidden md:flex h-navBar bg-headerTeal drop-shadow-md py-4">
            <div className="container mx-auto px-4">
                <ul className="flex justify-between">
                    ...
                    <li><a href="/prizes" className="text-navText text-teal-900 font-coco hover:text-teal-600"><Link to="prizes" spy={true} smooth={true} duration={500} offset={-50}>PRIZES</Link></a></li>
